        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-line">
              <th className="font-sans text-sm font-semibold text-ink/60 px-4 py-4">Name</th>
              <th className="font-sans text-sm font-semibold text-ink/60 px-4 py-4">Location</th>
          ...
          <tbody>
            {developments.map((dev) => (
              <tr key={dev.id} className="border-b border-line last:border-0 hover:bg-cream-alt transition-colors">
                <td className="px-4 py-4 font-sans text-sm text-navy font-medium">{dev.name}</td>
                <td className="px-4 py-3 font-sans text-sm text-ink/70">{dev.suburb}, {dev.state}</td>
                <td className="px-4 py-3 font-sans text-sm text-ink/70">{dev.status}</td>
